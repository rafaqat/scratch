...
export function FileTextIcon({ className = "w-16 h-16" }: IconProps) {
  return (
    <svg
      className={className}
      fill="none"
...
export function FolderIcon({ className = "w-20 h-20" }: IconProps) {
  return (
    <svg
      className={className}
      fill="none"
...
export function ArrowLeftIcon({ className = "w-4 h-4" }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
      {/* Lucide: ArrowLeft - for navigation back */}
